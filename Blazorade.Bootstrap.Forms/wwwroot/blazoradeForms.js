(function () {
	// Source: https://stackoverflow.com/questions/5916900/how-can-you-detect-the-version-of-a-browser#answer-38080051
	navigator.browser = (function () {
		...
		var wasm;
		switch (M[0]) {
			case 'Chrome': wasm = M[1] >= 57; break;
			case 'Edge': wasm = M[1] >= 16; break;
			case 'Firefox': wasm = M[1] >= 53; break;
			case 'Opera': wasm = M[1] >= 44; break;
			case 'Safari': wasm = M[1] >= 11; break;
		}

		return { name: M[0], version: M[1], wasm: wasm };
	})();
